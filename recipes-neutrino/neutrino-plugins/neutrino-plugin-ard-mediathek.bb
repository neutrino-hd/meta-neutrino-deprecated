...
do_install () {
	...
	install -m 644 ${S}/plugins/ard_mediathek/ard_mediathek.lua ${D}/var/tuxbox/plugins
	...
	install -m 644 ${S}/plugins/ard_mediathek/ard_mediathek_hint.png ${D}/var/tuxbox/plugins
}
