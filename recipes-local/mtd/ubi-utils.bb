...
PACKAGES =+ "ubinfo ubiattach ubidetach mtdinfo ubiupdatevol \
             ubimkvol ubirename ubirmvol ubirsvol"

FILES_ubinfo = "${sbindir}/ubinfo"
FILES_ubiattach = "${sbindir}/ubiattach"
FILES_ubidetach = "${sbindir}/ubidetach"
FILES_mtdinfo = "${sbindir}/mtdinfo"
FILES_ubiupdatevol = "${sbindir}/ubiupdatevol"
FILES_ubimkvol = "${sbindir}/ubimkvol"
FILES_ubirename = "${sbindir}/ubirename"
FILES_ubirmvol = "${sbindir}/ubirmvol"
FILES_ubirsvol = "${sbindir}/ubirsvol"
